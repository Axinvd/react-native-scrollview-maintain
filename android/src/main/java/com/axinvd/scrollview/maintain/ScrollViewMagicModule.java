package com.axinvd.scrollview.maintain;
...
public class ScrollViewMagicModule extends ReactContextBaseJavaModule {
  ...
  @ReactMethod
  public void enableMaintainVisibleContentPosition(final int viewTag, final int minIndexForVisible, final Promise promise) {
